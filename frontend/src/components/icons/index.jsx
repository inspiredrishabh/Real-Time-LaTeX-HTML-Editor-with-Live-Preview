 ...
 *
 * Centralizing icons makes it easier to maintain and swap them if needed
 */

export const CodeIcon = ({ className = "h-5 w-5 text-white" }) => (
  <svg
...
export const DocumentIcon = ({ className = "h-5 w-5 text-white" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    viewBox="0 0 20 20"
...
export const FullscreenIcon = ({ isFullScreen, className = "w-5 h-5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
    fill="currentColor"
